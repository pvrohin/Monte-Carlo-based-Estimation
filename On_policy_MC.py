...
def policy(state, Q):
	actions = [-1,1]
	greedy_action_probability = random()
	epsilon = 0.1

	if(greedy_action_probability > epsilon):
...
def Value_estimate(state, Q):
	...
	if Q[str(state)+','+str(1)] < Q[str(state)+','+str(-1)]:
		return Q[str(state)+','+str(-1)]*0.9 + (Q[str(state)+','+str(1)] + Q[str(state)+','+str(-1)])*0.05
	elif Q[str(state)+','+str(1)] > Q[str(state)+','+str(-1)]:
		return Q[str(state)+','+str(1)]*0.9 + (Q[str(state)+','+str(1)] + Q[str(state)+','+str(-1)])*0.05
	else:
...
#episode_lengths = [100, 1000, 2000, 3000, 4000, 5000, 6000, 8000, 10000]

#episode_lengths = [100, 1000]
